...
class xml_node_with_children : public xml_node
{
    ...
    public: 
        ...
        xml_node_with_children(std::string const& name):
        xml_node{name}
        {

        }
        xml_node_with_children(std::string const& name, std::size_t reserve): 
        xml_node_with_children{name}
        {
...
template <typename T> class value_node : public xml_node
{
    ...
    protected: 
     ...
     public:
        ...
        value_node(std::string const& name, T const& v) :
        xml_node{name} , datum(v)
        {
...
class note : public xml_node_with_children
{
    public: 
        note () = delete; 
       // ~note();
       note(std::string const& to, std::string const& from, std::string const& subject, std::string const& message) :
       xml_node_with_children{"note", 4}
       {
